              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="shop-item">
                  <div class="shop-item-image"><img src="foto_produk/<?php echo $perproduk['foto_produk']; ?>" alt="">
                    <div class="shop-item-detail"><a href="beli.php?id=<?php echo $perproduk['id_produk']; ?>" class="btn btn-round btn-b"><span class="icon-basket">Tambah Keranjang</span></a></div>
                  </div>
